...
package org.quickstart.reactivex.rxjava.async.util;
...
public class AsyncTest {
  ...
  public void testAction0() {
    ...
    Async.toAsync(action, Schedulers.immediate()).call().subscribe(new TestObserver<Object>(observer));
  ...
  public void testAction1() {
    ...
    Async.toAsync(action, Schedulers.immediate()).call(1).subscribe(new TestObserver<Object>(observer));
  ...
  public void testAction2() {
    ...
    Async.toAsync(action, Schedulers.immediate()).call(1, 2).subscribe(new TestObserver<Object>(observer));
  ...
  public void testAction3() {
    ...
    Async.toAsync(action, Schedulers.immediate()).call(1, 2, 4).subscribe(new TestObserver<Object>(observer));
  ...
  public void testAction4() {
    ...
    Async.toAsync(action, Schedulers.immediate()).call(1, 2, 4, 8).subscribe(new TestObserver<Object>(observer));
  ...
  public void testAction5() {
    ...
    Async.toAsync(action, Schedulers.immediate()).call(1, 2, 4, 8, 16).subscribe(new TestObserver<Object>(observer));
  ...
  public void testAction6() {
    ...
    Async.toAsync(action, Schedulers.immediate()).call(1, 2, 4, 8, 16, 32).subscribe(new TestObserver<Object>(observer));
  ...
  public void testAction7() {
    final AtomicInteger value = new AtomicInteger();
    Action7<Integer, Integer, Integer, Integer, Integer, Integer, Integer> action =
    ...
    Async.toAsync(action, Schedulers.immediate()).call(1, 2, 4, 8, 16, 32, 64).subscribe(new TestObserver<Object>(observer));
  ...
  public void testAction8() {
    final AtomicInteger value = new AtomicInteger();
    Action8<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> action =
    ...
    Async.toAsync(action, Schedulers.immediate()).call(1, 2, 4, 8, 16, 32, 64, 128).subscribe(new TestObserver<Object>(observer));
  ...
  public void testAction9() {
    final AtomicInteger value = new AtomicInteger();
    Action9<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer> action =
    ...
    Async.toAsync(action, Schedulers.immediate()).call(1, 2, 4, 8, 16, 32, 64, 128, 256).subscribe(new TestObserver<Object>(observer));
  ...
  public void testActionN() {
    ...
    Async.toAsync(action, Schedulers.immediate()).call(1, 2, 4, 8, 16, 32, 64, 128, 256, 512).subscribe(new TestObserver<Object>(observer));
  ...
  public void testFunc0() {
    ...
    Async.toAsync(func, Schedulers.immediate()).call().subscribe(new TestObserver<Object>(observer));
  ...
  public void testFunc1() {
    ...
    Async.toAsync(func, Schedulers.immediate()).call(1).subscribe(new TestObserver<Object>(observer));
  ...
  public void testFunc2() {
    ...
    Async.toAsync(func, Schedulers.immediate()).call(1, 2).subscribe(new TestObserver<Object>(observer));
  ...
  public void testFunc3() {
    ...
    Async.toAsync(func, Schedulers.immediate()).call(1, 2, 4).subscribe(new TestObserver<Object>(observer));
  ...
  public void testFunc4() {
    ...
    Async.toAsync(func, Schedulers.immediate()).call(1, 2, 4, 8).subscribe(new TestObserver<Object>(observer));
  ...
  public void testFunc5() {
    ...
    Async.toAsync(func, Schedulers.immediate()).call(1, 2, 4, 8, 16).subscribe(new TestObserver<Object>(observer));
  ...
  public void testFunc6() {
    ...
    Async.toAsync(func, Schedulers.immediate()).call(1, 2, 4, 8, 16, 32).subscribe(new TestObserver<Object>(observer));
  ...
  public void testFunc7() {
    ...
    Async.toAsync(func, Schedulers.immediate()).call(1, 2, 4, 8, 16, 32, 64).subscribe(new TestObserver<Object>(observer));
  ...
  public void testFunc8() {
    ...
    Async.toAsync(func, Schedulers.immediate()).call(1, 2, 4, 8, 16, 32, 64, 128).subscribe(new TestObserver<Object>(observer));
  ...
  public void testFunc9() {
    ...
    Async.toAsync(func, Schedulers.immediate()).call(1, 2, 4, 8, 16, 32, 64, 128, 256).subscribe(new TestObserver<Object>(observer));
  ...
  public void testFuncN() {
    ...
    Async.toAsync(func, Schedulers.immediate()).call(1, 2, 4, 8, 16, 32, 64, 128, 256, 512).subscribe(new TestObserver<Object>(observer));
