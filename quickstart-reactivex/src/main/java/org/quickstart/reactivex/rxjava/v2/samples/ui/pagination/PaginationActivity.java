package org.quickstart.reactivex.rxjava.v2.samples.ui.pagination;
...
public class PaginationActivity extends AppCompatActivity {
  ...
  private void subscribeForData() {
    ...
    Disposable disposable = paginator.onBackpressureDrop().concatMap(new Function<Integer, Publisher<List<String>>>() {
      @Override
