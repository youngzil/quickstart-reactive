...
import org.quickstart.reactivex.rxnetty.examples.tcp.loadbalancing.AbstractLoadBalancer;
 ...
 *
 * This load balancer uses a naive failure detector that removes the host on the first 503 HTTP response. The intention here is just to demonstrate how to write complex load balancing logic using
 * lower level constructs in the client.
 *
