 ...
 *
 * This load balancer uses a naive failure detector that removes the host on the first connection failure. The intention here is just to demonstrate how to write complex load balancing logic using
