...
/**
 * A client to test {@link PerfHelloWorldServer}. This client is provided here only for completeness of the example, otherwise, it is exactly the same as {@link HelloWorldClient}.
 */
public final class PerfHelloWorldClient {
  ...
  public static void main(String[] args) {
    ...
    HttpClient.newClient(serverAddress).enableWireLogging("perf-client", LogLevel.DEBUG).createGet("/hello")
