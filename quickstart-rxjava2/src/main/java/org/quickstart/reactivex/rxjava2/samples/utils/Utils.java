package org.quickstart.reactivex.rxjava2.samples.utils;

import java.util.ArrayList;
import java.util.List;

import org.quickstart.reactivex.rxjava2.samples.model.ApiUser;
import org.quickstart.reactivex.rxjava2.samples.model.User;
...
public class Utils {
  ...
  public static void logError(String TAG, Throwable e) {
    System.out.println(TAG + "onError errorMessage : " + e.getMessage());
  }
