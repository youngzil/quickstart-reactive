...
public final class StreamingServer {
  ...
  public static void main(final String[] args) {
    ...
    server = TcpServer.newServer().enableWireLogging("streaming-server", LogLevel.DEBUG).start(connection -> connection
        .writeStringAndFlushOnEach(Observable.interval(10, TimeUnit.MILLISECONDS).onBackpressureBuffer().map(aLong -> "Interval =>" + aLong + '\n')));
