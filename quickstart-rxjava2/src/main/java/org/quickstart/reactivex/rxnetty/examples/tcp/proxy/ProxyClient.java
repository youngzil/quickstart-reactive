...
import org.quickstart.reactivex.rxnetty.examples.tcp.echo.EchoClient;
...
/**
 * A client to test {@link ProxyServer}. This client is provided here only for completeness of the example, otherwise, it is exactly the same as {@link EchoClient}.
 */
public final class ProxyClient {
  ...
  public static void main(String[] args) {
    ...
    TcpClient.newClient(serverAddress).enableWireLogging("proxy-client", LogLevel.DEBUG).createConnectionRequest()
