...
public final class StreamingServer {
  ...
  public static void main(final String[] args) {
    ...
    server = HttpServer.newServer().enableWireLogging("streaming-server", LogLevel.DEBUG).start((req, resp) -> resp
        .writeStringAndFlushOnEach(Observable.interval(10, TimeUnit.MILLISECONDS).onBackpressureBuffer(10).map(aLong -> "Interval =>" + aLong)));
